...
class DfsWeb3 {
    ...
    prepareAccount() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const DFSPRoxyRegistyAbiItems = DFSProxyRegistry_json_1.default.map(item => (Object.assign(Object.assign({}, item), { stateMutability: item.stateMutability, type: item.type })));
            const dfsRegistry = new this.web3.eth.Contract(DFSPRoxyRegistyAbiItems, (0, addresses_1.getAddr)('DFSProxyRegistry', config_1.CONFIG.chainId));
    ...
    createSmartWallet() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ProxyRegistryAbiItems = ProxyRegistry_json_1.default.map(item => (Object.assign(Object.assign({}, item), { stateMutability: item.stateMutability, type: item.type })));
            const makerRegistry = new this.web3.eth.Contract(ProxyRegistryAbiItems, (0, addresses_1.getAddr)('ProxyRegistry', config_1.CONFIG.chainId));
    ...
    execute(address, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const DsProxyAbiItems = DsProxy_json_1.default.map(item => (Object.assign(Object.assign({}, item), { stateMutability: item.stateMutability, type: item.type })));
...
//# sourceMappingURL=DfsWeb3.js.map