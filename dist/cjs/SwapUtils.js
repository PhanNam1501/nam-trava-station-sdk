...
const RouterAbiItem = PancakeSwapRouter_json_1.default.map(item => (Object.assign(Object.assign({}, item), { stateMutability: item.stateMutability, type: item.type })));
const FactoryAbiItem = PancakeSwapFactory_json_1.default.map(item => (Object.assign(Object.assign({}, item), { stateMutability: item.stateMutability, type: item.type })));
const PairAbiItem = PancakeSwapPair_json_1.default.map(item => (Object.assign(Object.assign({}, item), { stateMutability: item.stateMutability, type: item.type })));
...
class SwapUtil {
    constructor(_web3) {
        this.web3 = _web3;
        this.FactoryContract = new FactoryContract(_web3, exports.PancakeSwapV2Address.FactoryAddress);
        this.RouterContract = new RouterContract(_web3, exports.PancakeSwapV2Address.RouterAddress);
    }
