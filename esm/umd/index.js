    ...
    return /******/ (() => {
        ...
        /******/ var __webpack_modules__ = ([
            ...
            /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                function _checkPrivateRedeclaration(obj, privateCollection) { if (privateCollection.has(obj)) {
                ...
                function _classPrivateMethodGet(receiver, privateSet, fn) { if (!privateSet.has(receiver)) {
                ...
                class Action {
                    ...
                    _replaceWithPlaceholders(arg, paramType) {
                        ...
                        if (typeof paramType === 'string') {
                            if (new RegExp(/\$\d+/).test(arg))
                                return _classPrivateMethodGet(this, _getPlaceholderForType, _getPlaceholderForType2).call(this, paramType);
                    ...
                    _formatType(paramType) {
                        if (Array.isArray(paramType))
                            return "(".concat(paramType.map(_paramType => this._formatType(_paramType)), ")");
                        return paramType;
                    }
                    /**
                ...
                function _getPlaceholderForType2(type) {
                    ...
                    if (type.startsWith('bytes'))
                        return "0x".concat('0'.repeat(parseInt(type.substr(5)) * 2));
                    if (type === 'address')
                        return "0x".concat('0'.repeat(40));
                    if (type === 'string')
                        return '';
                    return '0';
                }
                ...
                class Recipe {
                    ...
                    constructor(name) {
                        ...
                        actions.forEach(action => {
                            if (!(action instanceof _Action__WEBPACK_IMPORTED_MODULE_3__.Action))
                    ...
                    _validateParamMappings() {
                        this.actions.forEach((action, i) => {
                            action._getArgumentMapping().forEach((source, j) => {
                                if (source)
                                    console.log("".concat(this.actions[i].name, " takes argument #").concat(j + 1, " from ").concat(this.actions[source - 1].name, " (action #").concat(source, ")"));
                            });
                        });
                    }
                    /**
            ...
            /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                var getAddr = function getAddr(name) {
                    ...
                    if (!_config__WEBPACK_IMPORTED_MODULE_0__.CONFIG.testingMode) {
                        if (!actions)
                            throw new Error("Cannot find address for chainId: ".concat(_chainId, "."));
                        if (!actions[name])
                            throw new Error("Cannot find address for name: ".concat(name, " (chainId: ").concat(_chainId, ")."));
                    }
                    return actions[name];
                };
                /***/ 
            ...
            /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                var getNetworkData = chainId => {
                    ...
                    if (!networkData)
                        throw new Error("Cannot find network data for chainId: ".concat(chainId));
                    return networkData;
                };
                /**
                 *
                ...
                var configure = config => {
                    ...
                    newKeys.forEach(key => {
                        ...
                        if (key === 'chainId')
                            (0, _zennomi_tokens__WEBPACK_IMPORTED_MODULE_1__.set)('network', config[key]);
                    });
                };
            ...
            /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                class DfsWeb3 {
                    ...
                    createSmartWallet() {
                        var _this2 = this;
                        return _asyncToGenerator(function* () {
                            if (!_this2.accountReady)
                                yield _this2.prepareAccount();
                            if (!_this2.account)
                    ...
                    prepareBeforeExecute(action) {
                        var _this3 = this;
                        return _asyncToGenerator(function* () {
                            if (!_this3.accountReady)
                                yield _this3.prepareAccount();
                            if (!_this3.proxy)
                    ...
                    execute(address, params) {
                        var _this4 = this;
                        return _asyncToGenerator(function* () {
                            if (!_this4.accountReady)
                                yield _this4.prepareAccount();
                            if (!_this4.proxy)
            ...
            /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                var requireAddress = address => {
                    ...
                    if (address.length < 42)
                        throw new Error("Address too short (".concat(address.length, " instead of 42)"));
                 ...
                 *
                 */
                var parsePriceFromContract = (price, from, to) => new (decimal_js__WEBPACK_IMPORTED_MODULE_0___default())(price).div(Math.pow(10, (0, _zennomi_tokens__WEBPACK_IMPORTED_MODULE_1__.getAssetInfo)(to).decimals)).div(Math.pow(10, (18 - (0, _zennomi_tokens__WEBPACK_IMPORTED_MODULE_1__.getAssetInfo)(from).decimals))).toString();
                /**
                 ...
                 *
                 */
                var formatPriceForContract = (price, from, to) => new (decimal_js__WEBPACK_IMPORTED_MODULE_0___default())(price).mul(Math.pow(10, (0, _zennomi_tokens__WEBPACK_IMPORTED_MODULE_1__.getAssetInfo)(to).decimals)).mul(Math.pow(10, (18 - (0, _zennomi_tokens__WEBPACK_IMPORTED_MODULE_1__.getAssetInfo)(from).decimals))).floor().toString();
                /***/ 
            }),
            /* 35 */
            /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
